...
var mapIcon = true;
   ...
   $(function(){
		...
		function fn_search() {
				var url = "";
				url = "/idsiSFK/neo/ext/json/disasterNewsList/disasterNewsList.json";
				...
				$.getJSON(url, function(data) {
					...
					if(cnt>0 && totCnt > 0){
						...
						for(var i=0;i<cnt;i++){
							...
							gen.getChild( i , "a2" ).setHref( '/idsiSFK/neo/emp/er/emergency_er2_d.html?bbsOrdr=' + json.BBS_ORDR  );
							gen.getChild( i , "a3" ).setValue( json.USR_NM );
							gen.getChild( i , "a4" ).setValue( json.FRST_REGIST_DT );
						}
					}
					else{
